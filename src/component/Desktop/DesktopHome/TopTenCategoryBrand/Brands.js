...
class Brands extends PureComponent {
    ...
    render() {
                        ...
                        <Card.Body className="brandsBody">
                            <div className="d-flex">
                                ...
                                <div className="brandName d-flex justify-content-center align-items-center">
                                    <p className="brandTitle text-muted">brand name</p>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
        ...
        const brands = data.map((pd, index) => {
            return <Col key={pd.slug} xl={6} lg={6}>
...
function mapStateToProps(state) {
    ...
    const topTenBrandsLoading = state.brandReducer.topTenBrandsLoading
    return {
        topTenBrandsApi, backendApi, topTenBrandsData, topTenBrandsLoading
    };
}
