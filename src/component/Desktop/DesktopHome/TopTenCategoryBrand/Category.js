                                            ...
                                            <Card.Body className="brandsBody">
                                                <div className="d-flex">
                                                    ...
                                                    <div className="brandName d-flex justify-content-center align-items-center">
                                                        <p className="brandTitle text-muted">Category name</p>
                                                    </div>
                                                </div>
                                            </Card.Body>
                                        </Card>
                    ...
                    <Card className="brand-card">
                        <Card.Body className="brandsBody">
                            <div className="d-flex">
                                ...
                                <div className="brandName d-flex justify-content-center align-items-center">
                                    <p className="brandTitle">{pd.name.length > 10 ? pd.name.replace("————", "").replace("——", "").substring(0, 10) + "..." : pd.name.replace("————", "").replace("——", "")}</p>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
