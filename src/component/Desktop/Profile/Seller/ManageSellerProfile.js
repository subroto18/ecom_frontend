...
class ManageSellerProfile extends PureComponent {
  ...
  componentDidMount() {
    Api()
      .get("getSellerVerificationInstruction")
      .then((res) => {
        this.setState({
  ...
  onSubmit() {
    if (
      this.validator.fieldValid("message") &&
      this.validator.fieldValid("file")
    ) {
      let message = this.state.message;
      let selectedFile =
        this.props.dynamicData["selected_for_seller_verification"] !== undefined
          ? this.props.dynamicData["selected_for_seller_verification"]
          : null;
      const data = {
        message: message,
        media: selectedFile,
      ...
      <Fragment>
        <Container>
              ...
              <div className="seller-color-divs color-type3">
                <h4>
                  {currencySymbolFormat === 1 ? (
                    <span>
                      {onCurrencyFormat(this.state.total_earning)}
                      {defaultCurrency}
                    </span>
                  ) : (
                    <span>
            ...
            <Col lg={6} md={6} sm={6} xs={6} className="mb-3">
              <div className="seller-color-divs color-type6">
                <h4>
                  {currencySymbolFormat === 1 ? (
                    <span>
                      {onCurrencyFormat(this.state.earning_this_month)}
                      {defaultCurrency}
                    </span>
                  ) : (
                    <span>
                          ...
                          if (pd.verification_status != undefined) {
                            return (
                              <Fragment>
                                {pd.verification_status === 0 ? (
                                  ...
                                  <p>
                                    {" "}
                                    Your shop status is currently inactive. To
                                    active your shop, Talk to our support.
                                  </p>
                                ) : pd.shop_status === 1 ? (
                                  <Photo
                                    src="/verified.png"
                            ...
                            return (
                              <div className="text-center">
                                ...
                                <Button
                                  onClick={this.onVerifySeller}
                                  className="seller-dashboard-card-btn"
                                >
                                  Verify Now
                                </Button>
                              </div>
                      ...
                      {this.state.packageStatus == "Pending" ? (
                        <Fragment>
                          <div className="text-center">
                            ...
                            <h6 className="seller-package">
                              Package name: {this.state.packageName}
                            </h6>
                            <Button className="seller-dashboard-card-btn">
                              Package Status : {this.state.packageStatus}
                            </Button>
                          </div>
                        </Fragment>
                      ) : (
                        <Fragment>
                          <div className="text-center">
                            ...
                            <p className="seller-package">
                              Purchased date: {this.state.packagePurchasedDate}
                            </p>
                            <p className="seller-package">
                              Expiry date: {this.state.packageExpiryDate}
                            </p>
                          </div>
                        </Fragment>
                      )}
              ...
              <div className="seller-color-divs color-type1 seller-color">
                <div className="white-bg mb-3 seller-dashboard-card">
                  ...
                  <div className="text-center">
                    ...
                    <Link
                      href="/shop-setting"
                      className="seller-dashboard-card-btn btn"
                    >
                      Manage Now
                    </Link>
                  </div>
          ...
          <Modal
            ...
            scrollable={true}
            centered
            show={this.state.sellerVerifyModal}
            onHide={this.onCloseVerifyModal}
          >
                ...
                <Fragment>
                  <div className="instruction p-3">
                    <div className="instruction-content p-3">
                      <h6>Instruction</h6>
                      <div>{parse(this.state.instruction)}</div>
                    </div>
                  </div>
                  <div className="instruction form">
                      ...
                      <div className="mb-2 text-danger">
                        ...
                        {this.validator.message(
                          ...
                          this.props.dynamicData[
                            "selected_for_seller_verification"
                          ],
                          "required",
                        )}
                      </div>
                    ...
                    <div className="instruction form submit">
                      {this.state.loadingBtn ? (
                        ...
                        <Button onClick={this.onSubmit} className="float-right">
                          Submit
                        </Button>
                      )}
                    </div>
