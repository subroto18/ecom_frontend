...
class AddSellerProductPart extends PureComponent {
  constructor() {
    super();
    ...
    this.state = {
      ...
      variations_attr_field: "text",
      vatVariationField: "string",
      vatVariationTypeString: false,
      vatVariationTypeNumber: false,
      vatVariationTypeEmpty: false,
      tempVariation: [],
      submit: false,
      refundReplaceLoading: true,
      shipping_cost: 0,
      productTaxVariation: [],
  ...
  onCategoryChange(e) {
    this.setState({productCategory: e});
  }
  onBrandChange(e) {
    this.setState({productBrand: e});
  }
  onUnitChange(e){
    this.setState({
      unit:e.target.value
  ...
  onVideoProviderChange(e) {
    this.setState({productVideoProvider: e});
  }
  onVideoLinkChange(e){
    this.setState({
  ...
  onSubmitProduct() {
    ...
    if (checkVatEmptyOrNot===false && checkProductVariationEmptyOrNot===false && checkProductVariationNumOrNot===false && selectedVariationTypesEmptyOrNot===false &&  this.validator.fieldValid('productName') &&
      ...
      let productCategory = this.state.productCategory.value;
      let productBrand =  this.state.productBrand.value;
      ...
      let discountType =  this.state.discountType.value!=="" ? this.state.discountType.value : "flat";
      let stock_quantity =  this.state.stock_quantity!==""?this.state.stock_quantity:1;
      let sku_number = this.state.sku;
      let productVideoProvider =  this.state.productVideoProvider.value;
      ...
      Api().post('save-product',data).then(res=>{
        if(res.data===1){
  ...
  onPublishCallBack(){
    ...
    alert('success','Product has been inserted successfully!');
    ...
    this.setState({
      ...
      SelectProductVariationType: [],
      variationsMix: [],
      checkProductTaxVariationEmpty:false,
      loadingBtn:false
    })
    if(this.selectedVariationTypes.length>0){
      this.selectedVariationTypes.map((value, index) => {
    ...
    this.selectedVariationTypes = [];
    if( this.state.productTaxVariation.length>0){
      this.state.productTaxVariation.map(pd=>{
        this.setState({
          [pd.label]:'',
          [pd.label+"_type"]:''
    ...
    this.validator.hideMessageFor('unit');
    ...
    this.validator.hideMessageFor("minimumQuantity");
    this.validator.hideMessageFor("shippingDays");
    window.scroll(0,0);
  }
  /**
  ...
  render() {
    ...
    let seller_status = this.state.seller_status;
    ...
    if(loading){
      ...
      if(seller_status===1 && status==="Paid" && package_found===true && packageExpiryDate!=="expired" &&  remainingProduct>0){
        return   <Fragment>
          <Row>
            <Col lg={8}>
              <div>
                  ...
                  <div className="card-body text-left">
                    <div className="p-3">
                      ...
                      <Form.Group>
                        ...
                        <div className="text-danger my-2"> {this.validator.message('unit', this.state.unit, 'required')}</div>
                      </Form.Group>
                      <Form.Group >
                  ...
                  <div className="card-body text-left">
                    <Form.Group className="p-3 ">
                      <MediaUpload  title="Product gallery"
                                    ...
                                    multipleFile={true} type="gallery" for="product_gallery"  limit={5} widthSize={600} heightSize={600}   />
                      <MediaUpload required={true} title="Product thumbnail"
                                   ...
                                   multipleFile={true} type="thumbnail"
                                   for="product_thumbnail"  limit={1} widthSize={600} heightSize={600}   />
                ...
                <div className="card">
                  ...
                  <div className="card-body text-left">
                    <div className="p-3">
                      <Form.Group>
                        <Form.Label className="inputBoxTitle">Variation attributes</Form.Label>
                        <Select
                            className="inputTextSize"
                            isMulti
                      ...
                      {this.state.productVariationAttributes != null ?
                          this.selectedVariationTypes.map((vt, i) => {
                            return (
                                <Form.Group key={vt}>
                                  <Form.Label className="hdLabelBold inputBoxTitle">{vt}</Form.Label>
                                  <CreatableSelect
                                      className="inputTextSize"
                          ...
                          : ""}
                      <div className="text-danger my-2"> {this.validator.message('variations_attribute', this.state.variations_attr_field, 'required')}</div>
                    </div>
                  </div>
                </div>
                <div className="card">
                  ...
                  <div className="card-body text-left">
                    <div className="p-3">
                      <Form.Group>
                        ...
                        <Form.Control value={this.state.unit_price} type="text"  onChange={(e) => this.onUnitPriceChange(e)}  placeholder={('Enter product unit price')} />
                        <p className="text-danger my-2"> {this.validator.message('unit_price', this.state.unit_price, 'required|currency')}</p>
                      </Form.Group>
                      <Form.Group>
                        <Form.Label className="hdLabelBold">{('Purchase price')}</Form.Label>
                        <Form.Control value={this.state.purchase_price} type="text"  onChange={this.onPurchasePriceChange} placeholder={('Enter product purchase price')} />
                                ...
                                <Table striped bordered hover responsive>
                                  ...
                                  {this.state.variationsMix.map((vm, i) => {
                                    return (
                                        <tr key={vm}>
                                          <td>{vm}</td>
                                          <td>{<input type="text" className="form-control"  onChange={(e) => this.saveVariationTypesValue(vm+"_sku", e)} name={vm+"_sku"}/>}</td>
                                          <td>{<input type="text" className="form-control" onChange={(e) => this.saveVariationTypesValue(vm+"_price", e)} name={vm+"_price"}/>}</td>
                                          <td>{<input type="text" className="form-control"  onChange={(e) => this.saveVariationTypesValue(vm+"_stock", e)} name={vm+"_stock"}/>}</td>
                                          <td  className="variation_table_thumbnail">{<MediaUpload required={true} multipleFile={true} type={vm+"_image"} for="product_variation"  limit={1} widthSize={600} heightSize={600} productVariation={true}  />} </td>
                    ...
                    <div className="p-3">
                      <Form.Group>
                        ...
                        <Select
                            ...
                            value={this.state.productVideoProvider}
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="p-3 text-left">
                      ...
                      <Form.Group >
                        <Form.Label className="hdLabelBold">Meta description</Form.Label>
              ...
              <div>
                <div className="card">
                  ...
                  <div className="card-body p-3 text-left">
                    <ReactPlaceholder   showLoadingAnimation={true}  rows={6} ready={this.state.dataLoadingStatus}>
                      {this.state.shipping_method==='product_wise'  ?
                          <Fragment>
                            ...
                            <Form.Group className="p-3">
                              <Form.Label>{('Product wise')} {('shipping')}</Form.Label>
                              <Switch
                                  ...
                                  color="primary"
                              /><br/>
                              {this.state.productWiseShipping===true &&  <Fragment><Form.Control onChange={(e)=>this.onShippingFee(e)} type="text" data-product-add="shipping_fees" name="shipping_fees" placeholder={('Enter shipping fees')} />   </Fragment>   }
                              <Form.Text className="text-muted hd-info-text p-2">
                          ...
                          : this.state.shipping_method ==='seller_wise_flat' ?
                              <Fragment>
                                <Form.Text className="text-muted hd-info-text p-2">
                                  {('Seller wise flat rate is enable.If you want to change shipping method,Please go to shipping configuration and change it')}
                                </Form.Text>
                              </Fragment> : this.state.shipping_method == undefined ?
                                  <span></span>:
                                  <Form.Text className="text-muted hd-info-text p-2">
                                    {('Flat rate shipping is enable. If you want to change shipping method,Please go to shipping configuration and change it')}
                                  </Form.Text>
                      }
                ...
                <div className="card">
                  <div className="card-header p-3">
                    <hh6 className="card-title">Featured</hh6>
                  </div>
                  <div className="card-body">
                    <Form.Group>
                      <Switch
                  ...
                  <div className="card-body text-left">
                    <Form.Group  className="p-3">
                      ...
                      <InputGroup>
                        ...
                        />
                        <InputGroup.Append>
                          <InputGroup.Text className="inputDay">Days</InputGroup.Text>
                        </InputGroup.Append>
                ...
                <div className="card">
                  <div className="card-header p-3">
                    <hh6 className="card-title">Vat and Tax</hh6>
                  </div>
                  <div className="card-body">
                    <Form.Group className="p-3 text-left">
                    ...
                    {this.state.productTaxVariation.length>0 &&
                        <Fragment>
                          ...
                          {checkVatEmptyOrNot &&
                              <p className="text-danger my-2">{("Product tax")}</p>
                          }
                        </Fragment>
                    }
                  </div>
            ...
            <Col className="text-right" lg={12}>
              {this.state.dataLoadingStatus ?
                  ...
                  <Fragment>
                    <Button disabled={true} variant="success" type="submit" onClick={this.onSubmitProduct}>
                      publish
                    </Button>
                  </Fragment>
              }
...
export default connect(mapStateToProps, mapDispatchToProps)(AddSellerProductPart);
