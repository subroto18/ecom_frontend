...
class SellerDigitalProductPart extends PureComponent {
    constructor() {
        super();
        this.state = {
            loading:true,
    ...
    onUploadProduct(){
        ...
        if(uploadedProduct>=packageLimit){
            alert('info','Your limit has been fulled!');
        }else{
            Router.push("/add-digital-product")
        }
    }
    onPublish(index,value){
        ...
        if(value===1){
            ...
            Api().post('publishedSellerDigitalProduct',data).then(res=>{
                if(res.data===1){
                ...
                product.push({
                    ...
                    name:  <div className="product-title-div">
                        <div className="sellerProductThumbnailImage">
                            ...
                            <Photo
                                src={ this.props.backendApi+pro.thumbnail}
                                blurDataURL="/blank.jpg"
                                class="sellerProductThumbnail"
                            />
                                 ...
                                 <Fragment>
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="card">
                                            <div className="seller-color-divs color-type4 silverPackageDiv">
                                                <Row>
                                                    <Col lg={6} md={8} sm={8} xs={6} className="packageTextSize">
                                    ...
                                    <Col  lg={12} md={12} sm={12} xs={12}>
                                        <div className="card">
                                            ...
                                            <div className="card-body pt-0 pb-3 sellerTable sellerTableSize table-responsive-sm table-responsive-md table-responsive-lg">
                                                <MDBDataTable
                                                    striped
                                                    bordered
                                                    hover
                                 ...
                                 <Fragment>
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="card">
                                            <div className="seller-color-divs color-type4 silverPackageDiv">
                                                <Row>
                                                    <Col lg={6} md={8} sm={8} xs={6} className="packageTextSize packageTextField">
                                                        <p>Package Name: <span className='packageName'>{this.state.packageName}</span></p>
                                                        <p>Product Limit: {this.state.totalProduct}</p>
                                                        <p>Purchased Date: {this.state.packagePurchasedDate}</p>
                                                        <p>Expiry  Date: {this.state.packageExpiryDate=="expired" ? <span className="badge-danger">Expired</span> :  this.state.packageExpiryDate=="pending" ? <span className="badge-primary">Pending</span> : <span className="badge-success">{this.state.packageExpiryDate} </span>}</p>
                                                        <Link className="btn upgradeBtn" href="/seller-package"> Upgrade Package</Link>
                                                    </Col>
                                                    <Col lg={6} md={4} sm={4} xs={6}>
                                                        {this.state.packageThumbnail!==null &&
                                            ...
                                            <div className="card-header">
                                                <Fragment>
                                                    {this.state.seller_status!==0 &&
                                                        <Fragment>
                                                            {(expired!==true && this.state.status!==true ) &&
...
export default connect(mapStateToProps,mapDispatchToProps)(SellerDigitalProductPart);
