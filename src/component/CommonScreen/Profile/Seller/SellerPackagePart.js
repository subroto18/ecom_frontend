...
const OnlinePayment = dynamic(() => import('../../OnlinePayment/OnlinePayment'), {
    ssr: false,
})
...
class SellerPackagePart extends PureComponent {
    ...
    componentDidMount() {
        Api().get('getSellerPackage').then(res=>{
            this.setState({
                data:res.data,
                loading:false
            })
    ...
    onSubmit() {
        ...
        if (this.validator.allValid()) {
            ...
            let photo =   this.props.dynamicData['selected_for_offline_payment']!==undefined ? this.props.dynamicData['selected_for_offline_payment']: null
            ...
            Api().post('offline-seller-package-recharge',data).then(res=>{
    ...
    onPaymentType(e){
        ...
        if(e.value==="offline"){
            ...
            Api().get('getOfflinePayment').then(res=>{
                this.setState({
                ...
                <section className="sectionDiv">
                    <Container>
                        <div className=" p-5 mt-5 sellerPackageTitleDiv">
                            <h2 className="text-center premiumPackages ">Premium Packages for Sellers</h2>
                        </div>
                        <Row>
                            <Fragment>
                                ...
                                {this.state.loading ?
                                    <Fragment>
                                        <Col  lg={4} md={4} sm={12} xs={12}>
                                            <div className="card my-5 sellerPackage">
                                                {loader}
                                            </div>
                                        </Col>
                                        <Col  lg={4} md={4} sm={12} xs={12}>
                                                            ...
                                                            <Row>
                                                                <Col lg={6} md={12} sm={6}>
                                                                    <div className="seller-package-thumbnail-div ">
                                                                        ...
                                                                        <Photo
                                                                            src={pd.package_thumbnail!==null ? this.props.backendApi + pd.package_thumbnail : "/blank.jpg"}
                                                                ...
                                                                <Col lg={6} md={12} sm={6}>
                                                                    <div className="package-div sellerPackageDetails">
                                                                        <h4 className="package-name seller-package"><span className='sellerPackageName'>{pd.package_name}</span></h4>
                                                                        <h3 className="package-price seller-package">
                                                                            {currencySymbolFormat===1 ?
                                                                                <p>{onCurrencyFormat(pd.package_price)}{defaultCurrency} </p>
                                                                                  :
                                                                                <p>{defaultCurrency}{onCurrencyFormat(pd.package_price)} </p>
                                                                            }
                                                                        </h3>
                                                                        <p className="package-pp seller-package">Physical product:{pd.physical_product}</p>
                                                                        <p className="package-dp seller-package">Digital product:{pd.digital_product}</p>
                                                                        <p className="package-duration seller-package">Duration {pd.package_duration} days</p>
                                                                    </div>
                                                                    <div className="package-div pt-2">
                                                                        <Button onClick={()=>this.onBuyPackage(pd.package_index,pd.package_price)} >Buy Package </Button>
                                                                    </div>
                                                                </Col>
                                                            </Row>
                                                        </div>
                    ...
                    <OnlinePayment amount={this.state.packagePrice} packageId={this.state.packageId} modal={this.state.onlinePaymentModal} onModalHide={this.onlineModalHide} />

                    <Modal size="xl | lg | sm" className='responsiveModal offlinePaymentModal' centered scrollable={true} show={this.state.offlinePaymentModal} onHide={this.onOfflineModalHide} >
                        <Modal.Header>
                            <h6>Offline Package purchase</h6>
                            <button onClick={this.onOfflineModalHide} type="button" className="close" aria-label="Close">
                                                        ...
                                                        return  <Fragment>
                                                                    ...
                                                                    {pd.nameWithPhoto.map(np=>{
                                                                        return <Fragment>
                                                                            <label className="pGatewayLabel recharge mobilePGatewayLabel offlinePGateway">
                                                                                <input onChange={()=>this.onPaymentMethodChange(np.index)} className="pGatewayRadio"
                                                                                       checked={np.index===this.state.paymentMethodIndex}   type="radio" name="test" value={np.index}/>
                                                                                <span className="gatewayDiv offLinePayOption">
                                                                                    ...
                                                                                    <span className="pGatewayName offline-recharge">{np.name}</span>
                                                                                </span>
                                                                            </label>
                                                                        </Fragment>
                                                                    })}
                                                            ...
                                                            <div className="offline-wallet-recharge-content-div">
                                                                <div className="offline-wallet-content">
                                                                    ...
                                                                    {pd.instruction.map(ins=>{
                                                                        if(ins.index===this.state.paymentMethodIndex){
                                                                            return <Fragment className="paymentDetailsText">
                                                                                {ReactHtmlParser(ins.instruction)}
                                                                            </Fragment>
                                                                        }
                                                                    })
                                                                    }
                                                            ...
                                                            <Fragment>
                                                                {pd.bankDetails.map(bd=>{
                                                                    if(bd.index===this.state.paymentMethodIndex){
                                                                        if(bd.bankName!==null){
                                                                            return  <Fragment>
                                                                                    ...
                                                                                    <div className="offline-wallet-bank-content">
                                                                                        ...
                                                                                        <div className='sellerTableSize resSellerTable table-responsive-sm table-responsive-md table-responsive-lg'>
                                                                                            <Table striped bordered hover>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>{bd.bankName}</td>
                                                                                                    <td>{bd.accountName}</td>
                                                                                                    <td>{bd.accountNumber}</td>
                                                                                                    <td>{bd.routingNumber}</td>
                                                                                                </tr>
                                                            ...
                                                            <div className="offline-wallet-recharge">
                                                                <div className="form-group">
                                                                    ...
                                                                    <input onChange={(e)=>this.onAmount(e)}  type="text" className="form-control inputBoxSize"  placeholder="Enter your recharged Amount"/>
                                                                    <div className="mb-2 text-danger"> {this.validator.message('amount', this.state.amount, 'required|currency')}</div>
                                                                </div>
                                                                <div className="form-group">
                                                                    <label htmlFor="email">Transaction ID  * </label>
                                                                    <input onChange={(e)=>this.onTransaction(e)}  type="text" className="form-control inputBoxSize" placeholder="Enter your Transaction ID"/>
                                                                    <div className="mb-2 text-danger"> {this.validator.message('transactionId', this.state.transactionId, 'required')}</div>
                                                                </div>

                                                                <div className="form-group">
                                                                    <MediaUpload  title="payment receipt"  note="send your payment receipt after your payment"  multipleFile={false} type="offline_payment" for="offline_payment"  limit={1} widthSize={600} heightSize={600}   />
                                                                    <div className="mb-2 text-danger"> {this.validator.message('photo',this.props.dynamicData['selected_for_offline_payment'], 'required')}</div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="mt-3">
                                                                {this.state.loadingBtn ?
                                                                    ...
                                                                    <Button disabled={true} className="float-right"><span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"/>
                                                                        Loading...
                                                                    </Button>:
                    ...
                    <Modal key={2} size="md | sm" className='responsiveModal'  scrollable={true}  centered show={this.state.modal} onHide={this.onHandleClose}>
                        <Modal.Header>
                            <button onClick={this.onHandleClose} type="button" className="close" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </Modal.Header>
                                ...
                                <Fragment>{
                                       ...
                                       <Fragment>
                                           {this.state.sellerVerificationStatus.length > 0 ?
                                                       ...
                                                       return <Fragment>
                                                           {pd.verification_status === 0 ?
                                                               <Fragment>
                                                                   ...
                                                                   <p>You can only purchase package when your shop is verified. Wait for that, or talk to your support</p>
                                                                   <Link className="btn mt-3" href="/support-ticket">Create ticket</Link>
                                                               </Fragment>

                                                               :pd.verification_status===1 && pd.shop_status===0 ?
                                                                   <Fragment>
                                                                       <div className="text-center">
                                               ...
                                               :
                                               <div className="text-center">
                                                   <h6 className="text-danger">Sorry your shop is not verified</h6>
                                                   <p className="text-muted">You can not buy this package without verify your shop.</p>
                                                   <Link className="btn mt-3" to="/dashboard">Verify now</Link>
                                               </div>
                                           }
                                       </Fragment>
                                     }
