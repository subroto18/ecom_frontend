...
class UserAllReplaceOrderPart extends Component {
    constructor() {
        super();
        this.state = {
            loading:true,
    ...
    componentDidMount() {
        window.scroll(0,0)
        Api().get('getAllReplaceOrders').then(res=>{
            this.setState({
                data:res.data,
                loading:false
            })
                                  ...
                                  return  <div key={1} className="orderDiv ">
                                      <div className="d-flex justify-content-between">
                                          ...
                                          <div className='manageText'>
                                              <Link href={`order/replace-order/view/${pd.orderId.substring(1)}/productIndex/${pd.productIndex}/productId/${pd.productId}`}>MORE DETAILS</Link>
                                          </div>
                                      </div>
                                      <hr/>
                          ...
                          <div className="emptyPage">
                              <div className="py-5">
                                  <div className="text-center pageContent">
                                      ...
                                      <h6 className='text-muted'>There is no replaceable Order  yet</h6>
...
export default connect(mapStateToProps)(UserAllReplaceOrderPart);
