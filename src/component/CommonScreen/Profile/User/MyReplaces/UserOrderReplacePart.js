...
class UserOrderReplacePart extends PureComponent {
    constructor() {
        super();
    ...
    onSubmit(){
        if (this.validator.allValid()) {
            ...
            if(this.state.selectedDropOffOption!=="selectedDropOffOption"){
                if(this.state.selectedDropOffAddress!==""){
    ...
    onPostData(data){
        Api().post('postReplaceOrder',data).then(res=>{
            if(res.data===1){
                alert('success','Replace request has been placed');
                Router.push("/my-replaces")
            }
        }).catch(err=>{
            this.setState({
                loadingBtn:false
                              ...
                              return  <Fragment>
                                  <div className="d-flex order-cancel-details-div">
                                      ...
                                      <div   className="order-cancel-div oder-cd">
                                          ...
                                          />
                                          <div className="mb-2 text-danger"> {this.validator.message('returnReason', this.state.returnReason, 'required')}</div>
                                      </div>
                                  </div>
                                  <div className="order-cancel-details-div returnHeader">
                                      ...
                                      <div className="mb-2 text-danger"> {this.validator.message('additionalReason', this.state.additionalReason, 'required')}</div>
                                  </div>
                                  <div className="order-cancel-details-div returnHeader">
                                      ...
                                      <div className="mb-2 text-danger"> {this.validator.message('dropOffPoint', this.state.selectedDropOffOption, 'required')}</div>
                                  </div>
                                  <div className="order-cancel-details-div">
                                      ...
                                      <div className="d-flex">
                                          ...
                                          <span className='acceptedBox ml-2'> I have read and accepted the <Link href="/replace-policy">replace Policy.</Link></span>
                                      </div>
...
export default connect(mapStateToProps)(UserOrderReplacePart);
