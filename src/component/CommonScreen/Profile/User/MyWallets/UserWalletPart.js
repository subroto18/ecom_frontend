    ...
    onSubmit() {
        if (this.validator.allValid()) {
            this.setState({
                ...
                Api().post('offline-wallet-recharge',data).then(res=>{
                    if(res.data===1){
                        this.setState({
                            loadingBtn:false,
                            offlineModal:false,
          ...
          <Row className="mt-3">
                        <Col lg={3} md={12} sm={12} xs={12}>
                            <div className="wallet-div">
                                ...
                                <h6 className="wallet-recharge walletBalance"><i className="fal fa-wallet walletIcon myWalletIcon"/>Wallet balance</h6>
                                    {currencySymbolFormat===1 ?
                                        <p className="wallet-balance">{this.props.walletData.length>0 ? onCurrencyFormat(walletBalance) :onCurrencyFormat(0)}{defaultCurrency}</p>:
                                        <p className="wallet-balance">{defaultCurrency}{this.props.walletData.length>0 ? onCurrencyFormat(walletBalance) :onCurrencyFormat(0)}</p>
                                    }
                                </div>
                            </div>
                        </Col>
                          <Col lg={3} md={12} sm={12} xs={12}>
                              <div className="wallet-div">
                                  <div className="wallet-content-div balance">
                                      <h6 className="wallet-recharge walletBalance"><i className="fal fa-wallet walletIcon myWalletIcon"/>Total Recharge</h6>
                                      {currencySymbolFormat===1 ?
                                          <p className="wallet-balance">{this.props.walletData.length>0 ? onCurrencyFormat(totalRecharge) : onCurrencyFormat(0)}{defaultCurrency}</p>:
                                          <p className="wallet-balance">{defaultCurrency}{this.props.walletData.length>0 ? onCurrencyFormat(totalRecharge) : onCurrencyFormat(0)}</p>
                                      }
                                  </div>
                              </div>
                          </Col>
                            { (activePaymentGateway.paypalStatus===1) || activePaymentGateway.stripeStatus===1 || activePaymentGateway.sslcommerzStatus===1 ?
                               <Fragment>
                                   <Col lg={3} md={6} sm={6} xs={12}>
                                       <div onClick={this.onlineModalShow} className="wallet-div recharge">
                                   ...
                                   <Col lg={3} md={6} sm={6} xs={12}>
                                       <div onClick={this.onOfflineModalShow} className="wallet-div recharge">
                                           <div className="wallet-content-div">
                                               <i className="fad fa-plus-octagon addWalletIcon"/>
                        ...
                        <Row>
                            <Col lg={12}>
                                ...
                                {this.props.walletDataLoading ?
                                    ...
                                    :
                                    <Table striped bordered hover className="text-center table-style table-responsive-sm">
                                        <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Payment date</th>
                                                        ...
                                                        return <Fragment>
                                                            {pd.recharge_data.map((rd,i)=>{
                                                                return  <tr>
                                                                    ...
                                                                    {rd.status==="Pending" ?
                                                                        <td><span className="badge pending">{rd.status}</span></td>:
                                                                        <td><span className="badge approve">{rd.status}</span></td>
                                                                    }
                                                                </tr>
                                                            })}
                                                        </Fragment>
               ...
               <Modal size="xl | lg | sm" className='responsiveModal' centered scrollable={true} show={this.state.offlineModal} onHide={this.onOfflineModalHide} >
                  <Modal.Header>
               ...
               <OnlinePayment  modal={this.state.onlinePaymentModal} onModalHide={this.onlineModalHide} paymentFor="wallet"  callback={this.callBack} />
          </Container>
      </Fragment>
    )
  }
