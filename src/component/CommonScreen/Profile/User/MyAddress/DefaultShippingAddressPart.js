...
class DefaultShippingAddressPart extends PureComponent {
    constructor() {
        super();
        this.state = {
            data:[],
                            ...
                            return <tr className="tableTextSize">
                                ...
                                <td>
                                    <RadioGroup aria-label="shipping" name="shipping"   onChange={(e)=>this.handleChange(e,i)}>
                                        <FormControlLabel label="" checked={pd.defaultShipping} control={<Radio />}  />
                                    </RadioGroup>
                                </td>
                            </tr>
                        })}
...
export default connect(null, mapDispatchToProps)(DefaultShippingAddressPart);
