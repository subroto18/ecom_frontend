...
import Commissions from "../component/Desktop/Profile/Seller/Commissions/Commissions";
import MobileCommissions from "../component/Mobile/Profile/Seller/MobileCommissions";
...
CommissionPage.getInitialProps = async () => {
    ...
    try {
        ...
        const data = {
            ...
            title: "Commission History | " + res.meta_title
        }
        return {data}
    } catch (e) {
